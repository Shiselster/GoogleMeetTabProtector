...
- **Performance Optimized:** Uses non-blocking event listeners and optimized DOM observers to ensure zero lag during calls.

## 🔒 Privacy
This extension is committed to your privacy. It operates entirely locally within your browser. It does not collect, store, or transmit any personal data, browsing history, or meeting information to any external servers. No data is shared with third parties. Your meeting participation remains private.
